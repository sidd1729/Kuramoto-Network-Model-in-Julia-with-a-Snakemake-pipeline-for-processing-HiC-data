#Proper pipeline ideally for curve fitting
#library(readr)
...
K_vals_obj<-py_load_object(args[2], pickle = "pickle", convert = TRUE)
R_vals_obj<-py_load_object(args[3], pickle = "pickle", convert = TRUE)
...
plot(K_vals,R_vals,pch=19,main = args[5], xlab='k', ylab='r')
